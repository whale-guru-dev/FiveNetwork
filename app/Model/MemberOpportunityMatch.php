...
class MemberOpportunityMatch extends Model
{
    ...
    protected $fillable = ['opportunity_id', 'matched_member_id','binterest','score','reason','matched_structure','matched_stage','matched_state','matched_sector','matched_size','is_allowed'];
