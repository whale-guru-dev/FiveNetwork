(function($){
	...
	if (typeof(methodName) == "undefined" ) {
		...
		if (options.checkboxesGroups == "disabled") {
		    ...
		    groups.prop("disabled",true).parent("div").parent("label").css({"cursor":"not-allowed"});
		}
		if (options.checkboxesGroups == "disabled_grayed") {
		    ...
		    //this_checkbox.prop("disabled",true).parent("label").css({'color':'#c8c8c8'});
		    var groups = $(this).find('input:checkbox:not(".hummingbird-end-node")');
		    groups.prop("disabled",true).parent("div").parent("label").css({"cursor":"not-allowed",'color':'#c8c8c8'});
		}
 ...
 //    };
	...
	tree.children("li").children("label").children("div").children("input:checkbox").prop('indeterminate', false).prop('checked', false).trigger("click");
    };
	...
	tree.children("li").children("label").children("div").children("input:checkbox").prop('indeterminate', false).prop('checked', true).trigger("click");
	...
	var that_ul = that_node.parent("div").parent("label").siblings("ul");
	...
	if (collapseChildren === true) {
	    that_node.parent("div").parent("label").parent("li").find("ul").hide().siblings("i").removeClass(expandedSymbol).addClass(collapsedSymbol);
	} else {	    
	...
	if (disableChildren === true) {
	    this_checkbox.parent("div").parent("label").parent("li").find('input:checkbox').prop("disabled",true).parent("div").parent("label").parent("li").css({'color':'#c8c8c8',"cursor":"not-allowed"});
	} else {
	    //console.log(this_checkbox.prop("disabled",true).parent("label").parent("li"))
	    this_checkbox.prop("disabled",true).parent("div").parent("label").parent("li").css({'color':'#c8c8c8',"cursor":"not-allowed"});
	}
    };
	...
	var children_not_disabled_sum= this_checkbox.parent("div").parent("label").next("ul").children("li").children("label").children("div").children("input:checkbox:not(:disabled)").length;
	...
	//for a disabled unchecked node, set node checked and then trigger a click to uncheck
	//for a disabled checked node, set node unchecked and then trigger a click to check
	this_checkbox.prop("disabled",false).parent("div").parent("label").parent("li").css({'color':'#636b6f',"cursor":"default"});
	//all parents enabled
	...
	if (enableChildren === true) {
	    this_checkbox.parent("div").parent("label").parent("li").find('input:checkbox').prop("disabled",false).parent("div").parent("label").parent("li").css({'color':'#636b6f',"cursor":"default"});
	}
	this_checkbox.prop("checked",state === false);
	nodeEnabled = true;
	this_checkbox.trigger("click");	
	...
	if (onlyEndNodes == true) {
		...
		if (attr == "text") {
		    list.push($(this).parent("div").parent("label").parent("li").text());
		} else {
	...
	tree.find('input:checkbox').on('click', function(e) {
	    ...
	    //all not disabled
	    var nodes_below_not_disabled = $(this).parent("div").parent("label").parent("li").find("input:checkbox:not(:disabled)");

	    //all disabled without hummingbird-end-node
	    var nodes_below_disabled_groups = $(this).parent("div").parent("label").parent("li").find('input:checkbox:disabled:not(.hummingbird-end-node)');
		...
		$(this).parent("div").parent("label").parent().parents("li").children("label").children("div").children("input:checkbox").prop("indeterminate",true);
		$(this).parent("div").parent("label").parent().parents("li").children("label").children("div").children("input:checkbox").prop("checked",false);	
	    ...
	    $(this).parent("div").parent("label").siblings("ul").find("ul").map(function(){
	     	//console.log($(this))
		...
		var disabled_sum_children = $(this).children("li").children("label").children("div").children("input:checkbox:disabled").length;
		...
		//a check has happened
		    var checked_sum_children = $(this).children("li").children("label").children("div").children("input:checkbox:checked").length;
		    var unchecked_sum_children = $(this).children("li").children("label").children("div").children("input:checkbox:not(:checked)").length;
		...
		if (disabled_sum_children > 0) {
			...
			$(this).siblings("label").children("div").children("input:checkbox").prop("checked",false);
		    }
		    if (unchecked_sum_children == 0) {
			$(this).siblings("label").children("div").children("input:checkbox").prop("checked",true);
		    }
		    if (checked_sum_children > 0 && unchecked_sum_children > 0) {
			$(this).siblings("label").children("div").children("input:checkbox").prop("checked",false).prop("indeterminate",true);
		    }
		}
		...
		$(this).parent("label").parents("li").map(function() {
		    ...
		    //this is 0 if there are no checked, thus an uncheck has happened
	    		...
	    		$(this).parent().parent().parent().children("label").children("div").children("input:checkbox").prop("indeterminate",false);
	    		$(this).parent().parent().parent().children("label").children("div").children("input:checkbox").prop("checked",state);
	    	    }
		    ...
		    if (checkDisabled) {
				...
				$(this).parent().parent().parent().children("label").children("div").children("input[type='checkbox']").prop("disabled",true).parent("label").parent("li").css({'color':'#c8c8c8'});
			    }
		    	}
		    }		    
		});
		...
		if (doubleMode == false) {
	    	    ...
	    	    $(this).parent("div").parent("label").parent("li").find("input.hummingbird-end-node[type='checkbox']").each(function() {
		...
		if ($(this).hasClass("hummingbird-end-node") === false) {
		    ...
		    if (state === true) {
			var disabledCheckboxes = $(this).parent("div").parent("label").parent("li").find("input:checkbox:not(:checked):disabled");
			var num_state_inverse_Checkboxes = $(this).parent("div").parent("label").parent("li").find("input:checkbox:checked");
		    }
		    //if this box has been unchecked, check if "checked disabled" exist
		    if (state === false) {
			var disabledCheckboxes = $(this).parent("div").parent("label").parent("li").find("input:checkbox:checked:disabled");
			var num_state_inverse_Checkboxes = $(this).parent("div").parent("label").parent("li").find("input:checkbox:not(:checked)");
		    }
			...
			disabledCheckboxes.parent("div").parent("label").parent("li").parents("li").children("label").children("input:checkbox:not(:disabled)").prop("indeterminate",true).prop("checked",state);
		    }
		}
	    }
	    //--------------------------disabled-----------------------------------------//
