...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Detailed Simple Deal opportunity</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">Home</li>
            <li class="breadcrumb-item">pages</li>
            <li class="breadcrumb-item active">Detailed Simple Deal opportunity</li>
        </ol>
    </div>
</div>
		...
		<div class="col-12">
			<div class="card">
				<div class="card-header">
	            	<div class="row">
                        <div class="col-md-9">
                            <h4 class="m-b-0 text-white">Simple Deal Info</h4>
                        </div>
                    </div>
                </div>
	            <div class="card-body">
	                <form class="form-horizontal" role="form" >
	                    <div class="form-body">
	                        <h3 class="box-title">Simple Deal Info</h3>
...
<form action="{{route('admin.allow-simple-deal')}}" method="POST" id="allow-request-form">
	@csrf
	<input type="hidden" name="id" value="{{$request->id}}">
</form>
<form action="{{route('admin.deny-simple-deal')}}" method="POST" id="deny-request-form">
	@csrf
	<input type="hidden" name="id" value="{{$request->id}}">
</form>
<form action="{{route('admin.close-simple-deal')}}" method="POST" id="close-request-form">
	@csrf
	<input type="hidden" name="id" value="{{$request->id}}">
</form>
@endsection
