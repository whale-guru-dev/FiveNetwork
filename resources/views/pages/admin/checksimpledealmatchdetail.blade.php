...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Check Simple Deal Room Opportunity Match</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">Home</li>
            <li class="breadcrumb-item">pages</li>
            <li class="breadcrumb-item active">Check Simple Deal Room Opportunity Match</li>
        </ol>
    </div>
</div>
<!-- ============================================================== -->
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Check Simple Deal Room Opportunity Match - {{$name}}</h4>
                    <h6 class="card-subtitle">You can check simple deal room opportunity matching info and approve it to send email with highlight.</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="checkbox checkbox-success">
                                            <input type="checkbox" id="connected_member_{{$each->matchedMember->id}}" name="connected_member[]" value="{{$each->matchedMember->id}}" class="filled-in" >
                                            <label for="connected_member_{{$each->matchedMember->id}}"></label>
                                        </div>
                                    </td>
                                    <td>
...
<form action="{{route('admin.approve-simpledeal-match')}}" method="POST" id="approve-form">
    @csrf
    <input type="hidden" name="id" id="approve-id">
</form>

<form action="{{route('admin.connect-members-discuss')}}" method="POST" id="connect-form">
    @csrf
    <input type="hidden" name="connected_member_ids" id="connect-member-ids">
    <input type="hidden" name="type" value="simple">
    <input type="hidden" name="oppor_id" value="{{$oppor_id}}">
</form>
@endsection
