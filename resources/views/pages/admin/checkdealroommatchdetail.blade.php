...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Check Deal Room Opportunity Match</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">Home</li>
            <li class="breadcrumb-item">pages</li>
            <li class="breadcrumb-item active">Check Deal Room Opportunity Match</li>
        </ol>
    </div>
</div>
<!-- ============================================================== -->
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Check Deal Room Opportunity Match - {{$name}}</h4>
                    <h6 class="card-subtitle">You can check deal room opportunity matching info and approve it to send email with highlight.</h6>
...
<form action="{{route('admin.approve-dealroom-match')}}" method="POST" id="approve-form">
    @csrf
