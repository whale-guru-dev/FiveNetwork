...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h3 class="text-themecolor">Approve Deal Room Opportunity</h3>
    </div>
    <div class="col-md-7 align-self-center">
        <ol class="breadcrumb">
            <li class="breadcrumb-item">Home</li>
            <li class="breadcrumb-item">pages</li>
            <li class="breadcrumb-item active">Approve Deal Room Opportunity</li>
        </ol>
    </div>
</div>
<!-- ============================================================== -->
...
<div class="container-fluid">
    ...
    <div class="row" id="apply-nonco">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Approve Company Submitted Investment Questionnaire Opportunities.</h4>
                    <h6 class="card-subtitle">You can approve Company Submitted Investment Questionnaire Opportunities.</h6>
    ...
    <!-- End PAge Content -->
    <!-- ============================================================== -->
    <div class="row" id="apply-simple">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">Approve Member Submitted Investment Opportunities.</h4>
                    <h6 class="card-subtitle">You can approve Member Submitted Investment Opportunities.</h6>
                    <div class="table-responsive m-t-40">
