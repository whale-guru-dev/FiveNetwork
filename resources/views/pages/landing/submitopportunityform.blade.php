...
<head>
    ...
    <title>Family Investment Exchange | Investment Opportunity Questionnaire</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header card-no-border logo-center">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="percent_cur_revenue" class="form-control required mask-percent" id="percent_cur_revenue" data-inputmask="'alias': 'percentage'" required value="@php if(isset($form)) echo $form->percent_cur_revenue; else echo '0'; @endphp" maxlength="255">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="date" name="expected_cash_flow_break_date" id="expected_cash_flow_break_date" class="form-control required" required value="@php if(isset($form)) echo $form->expected_cash_flow_break_date; @endphp">
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <form>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" value="{{route('investment-questionnaire-form',['code' => $opportunitymember->code])}}" readonly="">
                                <div class="input-group-append">
                                    <button class="btn btn-info" type="button" id="copy-btn" data-clipboard-text="{{route('investment-questionnaire-form',['code' => $opportunitymember->code])}}" data-clipboard-action="copy"><i class="fa fa-copy"></i></button>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
    ...
    @if(($submitted == 1) && !Session::get('msg'))
    <script type="text/javascript">
        window.location.href= "{{route('home')}}";
    </script>
    @endif
